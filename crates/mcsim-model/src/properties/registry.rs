...
pub const ALL_PROPERTIES: &[&PropertyDef] = &[
    ...
    &AGENT_DIRECT_RETRIES.def,
    // Agent TRACE
    &AGENT_TRACE_ENABLED.def,
    &AGENT_TRACE_STARTUP_S.def,
    &AGENT_TRACE_STARTUP_JITTER_S.def,
    &AGENT_TRACE_TARGETS.def,
    &AGENT_TRACE_INTERVAL_S.def,
    &AGENT_TRACE_INTERVAL_JITTER_S.def,
    &AGENT_TRACE_RESPONSE_TIMEOUT_S.def,
    &AGENT_TRACE_MESSAGE_COUNT.def,
    &AGENT_TRACE_SHUTDOWN_S.def,
    &AGENT_TRACE_TAG.def,
    &AGENT_TRACE_AUTH.def,
    &AGENT_TRACE_FLAGS.def,
    // Agent Login
    &AGENT_LOGIN_ENABLED.def,
    &AGENT_LOGIN_STARTUP_S.def,
    &AGENT_LOGIN_STARTUP_JITTER_S.def,
    &AGENT_LOGIN_TARGETS.def,
    &AGENT_LOGIN_PASSWORD.def,
    &AGENT_LOGIN_RESPONSE_TIMEOUT_S.def,
    &AGENT_LOGIN_INTERVAL_S.def,
    ...
    &FIRMWARE_DIRECT_SWARM_FWD.def,
    &FIRMWARE_SWARM_RELAY_SNR_A.def,
    &FIRMWARE_SWARM_RELAY_SNR_B.def,
    &FIRMWARE_FLOOD_SUPPRESS.def,
    &FIRMWARE_FLOOD_SUPPRESS_SNR_HI.def,
    &FIRMWARE_FLOOD_SUPPRESS_SNR_LO.def,
    &FIRMWARE_FLOOD_SUPPRESS_DELAY_X.def,
    // Metrics (Node scope)
    &METRICS_GROUPS.def,
